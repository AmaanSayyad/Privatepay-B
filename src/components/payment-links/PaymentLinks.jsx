...
export default function PaymentLinks() {
  ...
  const getPaymentPageUrl = (alias) =>
    `${window.location.origin}/payment/${alias}`;

  const handleCopyPaymentUrl = (alias) => {
    navigator.clipboard.writeText(getPaymentPageUrl(alias));
      ...
      <div className="flex items-center justify-between w-full px-6 pt-6">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="bg-white rounded-full h-10 w-10 min-w-0 flex items-center justify-center"
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        handleCopyPaymentUrl(link.alias);
                      }}
